...
function UserInterface() {
    ...
    if(signer === null && provider === null)
        ...
        return (
            ...
            <div>
                <ul>
                    <TabNav title="Items" id="Items" activeTab={activeTab} prestate={state} setState={setTabstate} setActiveTab={setActiveTab} />
                    <TabNav title="On sale" id="On sale" activeTab={activeTab} prestate={state} setState={setTabstate} setActiveTab={setActiveTab} />
                    <TabNav title="Offers" id="Offers" activeTab={activeTab} prestate={state} setState={setTabstate} setActiveTab={setActiveTab} />
                </ul>
                ...
                <div>
                    <TabContent id="Items" activeTab={activeTab}>
                        <MyAssets signer={signer} provider={provider} condition={condition}/>
                        {/* <MyAssets/> */}
                    </TabContent>
                    ...
                    <TabContent id="Offers" activeTab={activeTab}>
                        <Tes signer={signer} provider={provider} condition={condition}/>
                        {/* <Tes/> */}
                    </TabContent>
                </div>
            </div>
